...
engine = sqlalchemy.create_engine('sqlite:///ETHUSDstream.db')
...
ws.send('{"event":"subscribe", "subscription":{"name":"trade"}, "pair":["ETH/USD"]}')
...
#        continue
    ...
    frame.to_sql('ETHUSD', engine, if_exists='append', index=False)
    print(frame)
